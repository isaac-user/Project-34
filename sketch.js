...
function preload()
{
  ...
  racoon = loadImage('cartoon-raccoon-waving-on-white-background-free-vector.jpg');
...
function setup() 
{
  ...
  racoon = createSprite(200,620,100,100);
  racoon.addImage("racoon",racoon);
  racoon.scale = 0.2;

//  racoon.addAnimation('blinking',blink);
//   racoon.addAnimation('eating',eat);
//   racoon.addAnimation('crying',sad);
//   racoon.changeAnimation('blinking');
...
function draw() 
{
  ...
  if(collide(fruit,racoon,80)==true)
  {
    World.remove(engine.world,fruit);
    fruit = null;
    racoon.changeAnimation('eating');
    eating_sound.play();
  }

  if(fruit!=null && fruit.position.y>=650)
  {
    racoon.changeAnimation('crying');
    bk_song.stop();
    sad_sound.play();
    fruit=null;
   }
